...
public class PenguinRookery implements TableFormatter {
   ...
   public static void main(String[] args) {
       ...
       for (int rows = 1; rows < MAX_PENGUINS && inputArray[rows][0] != null; rows++) {
            ...
            penguinArray[penguinCount++] = new Penguin(newSampleNum, newBodyMass, newSex,  
                                           newCulmenLen, newCulmenDepth, newSpecies,
                                           newFlipperLen); 
       } 
      ...
      Penguin test1 = new Penguin(400, 3800, Sex.F, 33.3, 15.1, PenguinSpecies.GENTOO, 200.4);
      Penguin test2 = new Penguin(400, 3800, Sex.F, 33.3, 15.1, PenguinSpecies.GENTOO, 200.4);
